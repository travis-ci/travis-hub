...
#
#     def data_for(object)
#       Travis::Api.data(object, { :params => { :some => 'thing' } })
#     end
#
#     before :each do
#       repo.class.stubs(:base_class).returns(stub('base_class', :name => 'Repository'))
#       Travis::Api::Http::Repository.stubs(:new).returns(builder)
#     end
#
...
#         Travis::Api::Http::Repository.expects(:new).with(repo, :some => 'thing').returns(builder)
#         data_for(repo).should == 'data'
#       end
#
#       it 'given an object that responds to :klass (aka Arel::Relation)' do
#         Travis::Api::Http::Repositories.expects(:new).with(repos, :some => 'thing').returns(builder)
...
#         Travis::Api::const_set :Http, Class.new
#         Travis::Api::Http.const_set :Job, Class.new
#         Travis::Api::Http::Job.const_set :Test, Class.new
