    ...
    class Config
      class Notify
        ...
        DEFAULTS = {
          ...
          canceled:{ email: :always, webhooks: :always, campfire: :always, discord: :always, hipchat: :always, irc: :always, flowdock: :always, sqwiggle: :always, slack: :always, pushover: :always },
          errored: { email: :always, webhooks: :always, campfire: :always, discord: :always, hipchat: :always, irc: :always, flowdock: :always, sqwiggle: :always, slack: :always, pushover: :always }
        }
