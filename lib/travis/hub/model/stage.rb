class Stage < ActiveRecord::Base
  ...
  def private
    ...
    def cancel_pending_jobs
      ...
      # builds in Gatekeeper (and a race condition between Gatekeeper and Hub,
      # see https://github.com/travis-pro/team-teal/issues/1167 and
