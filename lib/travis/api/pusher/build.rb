...
module Travis
  module Api
    module Pusher
      class Build
        require 'travis/api/pusher/build/canceled'
        require 'travis/api/pusher/build/created'
        require 'travis/api/pusher/build/received'
        require 'travis/api/pusher/build/started'
        require 'travis/api/pusher/build/finished'
